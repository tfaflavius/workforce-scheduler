...
const CreateDomiciliuRequestDialog: React.FC<CreateDialogProps> = ({ open, onClose, requestType }) => {
  ...
  const handleLocationChange = (value: string) => {
    ...
    setFormData(prev => ({
      ...prev,
      location: value,
      googleMapsLink: wasAutoGenerated ? generateMapsLink(value) : prev.googleMapsLink,
    }));
  };
    ...
    >
      ...
      <DialogContent sx={{ pt: 3 }}>
        <Stack spacing={2.5}>
          ...
          <TextField
            label="Număr contract/autorizație (opțional)"
          ...
          <TextField
            ...
            multiline
            rows={3}
            placeholder="Descrieți detaliile solicitării..."
          />
        </Stack>
      </DialogContent>
                  ...
                  <CardContent>
                    <Stack spacing={2}>
                      <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 1 }}>
                        ...
                        <Box>
                          <Typography variant="body2" color="text.secondary">Locație parcare</Typography>
