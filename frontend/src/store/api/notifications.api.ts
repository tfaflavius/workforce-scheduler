...
export type NotificationType =
  ...
  | 'PARKING_DAMAGE_ASSIGNED'
  | 'PARKING_DAMAGE_RESOLVED'
  | 'HANDICAP_REQUEST_ASSIGNED'
  | 'HANDICAP_REQUEST_RESOLVED'
  | 'DOMICILIU_REQUEST_ASSIGNED'
  | 'DOMICILIU_REQUEST_RESOLVED'
  | 'DOMICILIU_REQUEST_DEADLINE_APPROACHING'
  | 'LEGITIMATION_ASSIGNED'
  | 'LEGITIMATION_RESOLVED'
  | 'CONTROL_SESIZARE_ASSIGNED'
  | 'CONTROL_SESIZARE_RESOLVED'
  | 'PV_SESSION_ASSIGNED'
  | 'PV_SESSION_UPDATED'
  | 'PV_SIGNING_ASSIGNED'
  | 'PV_SIGNING_UPDATED'
