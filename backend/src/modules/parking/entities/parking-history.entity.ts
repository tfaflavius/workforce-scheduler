...
export type ParkingHistoryEntityType = 'ISSUE' | 'DAMAGE' | 'COLLECTION' | 'HANDICAP_REQUEST' | 'DOMICILIU_REQUEST' | 'HANDICAP_LEGITIMATION' | 'REVOLUTIONAR_LEGITIMATION' | 'PV_DISPLAY_SESSION' | 'PV_DISPLAY_DAY' | 'PV_SIGNING_SESSION' | 'PV_SIGNING_DAY' | 'CONTROL_SESIZARE';
