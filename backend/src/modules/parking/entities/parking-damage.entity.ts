...
@Index('IDX_parking_damages_status', ['status'])
@Index('IDX_parking_damages_parking_lot_id', ['parkingLotId'])
@Index('IDX_parking_damages_is_urgent', ['isUrgent'])
@Index('IDX_parking_damages_created_at', ['createdAt'])
