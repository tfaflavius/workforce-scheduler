...
@Entity('pv_signing_days')
export class PvSigningDay {
  ...
  // Data semnarii
  @Column({ name: 'signing_date', type: 'date' })
  signingDate: Date;
  ...
  // Numar procese verbale de semnat (minim 30)
  ...
  @Column({ name: 'maintenance_user2_claimed_at', type: 'timestamptz', nullable: true })
  maintenanceUser2ClaimedAt: Date;
  ...
  // Relations
  @ManyToOne(() => PvSigningSession, (session) => session.days, { onDelete: 'CASCADE' })
  @JoinColumn({ name: 'session_id' })
  session: PvSigningSession;

  @ManyToOne(() => User, { onDelete: 'SET NULL' })
  @JoinColumn({ name: 'maintenance_user1_id' })
  maintenanceUser1: User;

  @ManyToOne(() => User, { onDelete: 'SET NULL' })
  @JoinColumn({ name: 'maintenance_user2_id' })
  maintenanceUser2: User;
